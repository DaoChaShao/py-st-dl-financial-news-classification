...
def prepare_data() -> tuple[TorchDataLoader, TorchDataLoader, int, ndarray]:
    """ Prepare data """
    # Get data
    features4train, labels4train, features4valid, labels4valid, MAX_SEQ_LEN, balanced_weights = process_data()
    ...
    return dataloader4train, dataloader4valid, MAX_SEQ_LEN, balanced_weights
